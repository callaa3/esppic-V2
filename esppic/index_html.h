...
<body>
    <header>
        ...
        <span class="labu">
        <select name="device">
        <option value="16LF1847" selected>PIC16LF1847 (Dyson BMS)</option>
        <option value="16F1705">PIC16F1705</option>
        </select>
...
<script>
    ...
    var configItems = {
        ...
        "MCLRE": {
            ...
            values: {
                ...
                "0": "MCLR/VPP pin function is digital input; MCLR internally disabled"
            }
        },
        ...
        "FOSC": {
            ...
            values: {
                "111": "ECH: External Clock, High-Power mode (4-20 MHz)",
        ...
        "WRT": {
            ...
            values: {
                ...
                "10": "0000h to 1FFh write protected, 0200h to 1FFFh may be modified",
    ...
    // PIC16LF1847 config word bit layout
